...
export function language() {
    return [
        ...
        },
        {
            ...
            snippet: '',
            properties: [
                {js: 'parseInt', la: 'الى_صحيح', snippet: 'الى_صحيح($0)'},
                {js: 'parseFloat', la: 'الى_حقيقي', snippet: 'الى_حقيقي($0)'},
                {js: 'isNaN', la: 'هو_ليس_رقم', snippet: 'هو_ليس_رقم($0)'},
                {js: 'isFinite', la: 'هو_منتهي', snippet: 'هو_منتهي($0)'},
                {js: 'decodeURI', la: 'فك_تشفير_رابط', snippet: 'فك_تشفير_رابط($0)'},
                {js: 'decodeURIComponent', la: 'فك_تشفير_رابط_شامل', snippet: 'فك_تشفير_رابط_شامل($0)'},
                {js: 'encodeURI', la: 'تشفير_رابط', snippet: 'تشفير_رابط($0)'},
                {js: 'encodeURIComponent', la: 'تشفير_رابط_شامل', snippet: 'تشفير_رابط_شامل($0)'},
                {js: 'escape', la: 'تشفير', snippet: 'تشفير($0)'},
                {js: 'unescape', la: 'فك_تشفير', snippet: 'فك_تشفير($0)'},
            ]
        }, {
            type: 'class',
            js: 'Array',
            ...
            snippet: 'لوحة',
            properties:[
                {js: 'print', la: 'اطبع', snippet: 'اطبع($0)', autoComplete: true},
                {js: 'clear', la: 'تفريغ', snippet: 'تفريغ()', autoComplete: true},
                {js: 'askText', la: 'اسأل_نص', snippet: 'اسأل_نص("$0")', autoComplete: true},
                {js: 'askDate', la: 'اسأل_تاريخ', snippet: 'اسأل_تاريخ("$0")', autoComplete: true},
                {js: 'askNumber', la: 'اسأل_رقم', snippet: 'اسأل_رقم("$0")', autoComplete: true},
                {js: 'askRange', la: 'اسأل_نطاق', snippet: 'اسأل_نطاق("$1",${2:الأدنى},${3:الأقصى},${4:الخطوة})', autoComplete: true},
                {js: 'askColor', la: 'اسأل_لون', snippet: 'اسأل_لون("$0")', autoComplete: true},
                {js: 'askYesNo', la: 'اسأل_نعم_لا', snippet: 'اسأل_نعم_لا("$0")', autoComplete: true},
                {js: 'askMultiple', la: 'اسأل_لائحة', snippet: 'اسأل_لائحة("$0",["",""])', autoComplete: true},
            ]
        }
    ]
}
